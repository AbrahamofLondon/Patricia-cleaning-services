...
const CONTACT_EMAIL =
  process.env.NEXT_PUBLIC_CONTACT_EMAIL || "abepokmogpa1@gmail.com";
const CONTACT_PHONE_DISPLAY =
  process.env.NEXT_PUBLIC_CONTACT_PHONE || "07377 339910";
const CONTACT_PHONE_TEL = (CONTACT_PHONE_DISPLAY || "").replace(/\s+/g, "");
    ...
    <div>
      ...
      <section id="home" className="bg-blue-50 py-16 text-center">
        <h1 className="text-4xl font-bold mb-4">
          Welcome to Patricia’s Cleaning Services
        </h1>
        <p className="text-lg mb-4 max-w-2xl mx-auto">
          Reliable, professional, and trustworthy housekeeping. Minimum 4 hours
