...
export default function Booking() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // fd.append("_subject", `Booking: ${form.name} • ${form.date} • ${form.hours}h`);
      // fd.append("_replyto", form.email);
      // fd.append("_redirect", "https://YOUR_DOMAIN/thanks");

      await fetch(FORMSPREE, { method: "POST", body: fd, mode: "no-cors" });
